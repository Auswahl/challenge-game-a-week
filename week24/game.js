...
var GameState = function(game) {
    this.MAX_MISSILES = 1; // number of missiles
};
...
GameState.prototype.preload = function() {
    ...
    game.load.atlasJSONHash('bird', 'assets/raw/sprites1.png', 'assets/raw/sprites.js');
...
var Missile = function(game, x, y) {
    ...
    this.SMOKE_LIFETIME = 0; // milliseconds
    ...
    this.animations.add('fly', ['b1.png', 'b2.png', 'b3.png', 'b2.png'], 6, true);
